...
ap.seed(
  ...
  advanced_description: 'Looking ahead, you can see the Forest Path out ahead, covered in a '\
'thin trail of leaves from the Trees that have been cut down for their Aurel Bark.'
)
...
ap.seed(
  id: 12,
  description: 'This clearing appears to be some sort of crossroads, the sign you can barely '\
'make out. You can see to your West that there is a long and windy path, which looks worn.',
  advanced_description: 'The path is covered in a thin layer of leaves and shavings of '\
'Aurel Bark, an oft harvested ingredient by workers that used to be sold in Newtown. You '\
'attempt to read the worn sign, but can only see at the bottom that there is mention of a Reward?',
  type: 'Out of Town',
  location_id: 'forest_path'
)
...
ap.seed(
  id: 20,
  description: 'The room is covered in blood, stained from the battles of past. There is a '\
