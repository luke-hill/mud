...
[50, 58].each do |id_number|
  ap.seed(
    id: id_number,
    description: "This secluded area is notorious for being prime looting territory for local Bandits. You've "\
"happened on one of the inevitable dead-ends. Usually used to ambush travellers, you prepare for the worst.",
...
ap.seed(
  id: 59,
  description: 'The guards at this gatehouse protect this city well, judging by how pristine everything looks. '\
'The city has an air of arrogance about it and the Guards do nothing to quell that, dressed in the '\
'finest Steel Chainmail.',
