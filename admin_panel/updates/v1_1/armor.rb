...
ap.seed(
  id: 'wolf_hide',
  name: 'Wolf Hide',
  description: 'The smooth silken fur of a Forest Path Wolf. This looks like it offers average protection for the beast. '\
               'It is adorned with a few puncture marks where previous adventurers have attempted to slay it.',
  defense: 3
)
