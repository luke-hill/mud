...
5) enable up and down directions. Begin to add the first 10-20 places on the map where up and down are viable
...
10) Allow gold to be dropped and picked up (Currently just traded from hand) - Low Priority!
